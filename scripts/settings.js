...
const changePasswordTemplate = `
  ...
  Change Password Change Password Old Password New Password At
  least 8 characters Confirm New Password Save Password
`;
